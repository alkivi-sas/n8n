...
__decorate(
	[(0, config_1.Env)('N8N_ENFORCE_SETTINGS_FILE_PERMISSIONS'), __metadata('design:type', Boolean)],
	InstanceSettingsConfig.prototype,
	'enforceSettingsFilePermissions',
	void 0,
);
exports.InstanceSettingsConfig = InstanceSettingsConfig = __decorate(
	[config_1.Config, __metadata('design:paramtypes', [])],
