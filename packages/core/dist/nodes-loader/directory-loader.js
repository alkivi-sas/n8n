...
class DirectoryLoader {
	...
	applySpecialNodeParameters(nodeType) {
		...
		if (nodeType.webhook && supportsCORS) {
			...
			if (optionsProperty)
				optionsProperty.options = [...constants_1.commonCORSParameters, ...optionsProperty.options];
			else properties.push(...constants_1.commonCORSParameters);
		}
