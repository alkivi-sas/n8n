...
export declare function assertBinaryData(
...
export declare function getBinaryDataBuffer(
	inputData: ITaskDataConnections,
	itemIndex: number,
	propertyName: string,
	inputIndex: number,
...
export declare function copyBinaryFile(
	workflowId: string,
	executionId: string,
	filePath: string,
	fileName: string,
...
export declare function prepareBinaryData(
...
export declare const getBinaryHelperFunctions: (
