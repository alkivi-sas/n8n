...
export declare abstract class NodeExecutionContext
	implements Omit<FunctionsBase, 'getCredentials'>
{
	...
	protected _getCredentials<T extends object = ICredentialDataDecryptedObject>(
		type: string,
	...
	evaluateExpression(
		...
		| import('n8n-workflow').INodeParameters
		| import('n8n-workflow').NodeParameterValue
		| import('n8n-workflow').INodeParameters[]
		| import('n8n-workflow').NodeParameterValue[];
