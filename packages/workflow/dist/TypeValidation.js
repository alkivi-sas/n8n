...
exports.tryToParseJwt =
	exports.tryToParseUrl =
	exports.getValueDescription =
	exports.tryToParseJsonToFormFields =
	exports.tryToParseObject =
	exports.tryToParseArray =
	exports.tryToParseTime =
	exports.tryToParseDateTime =
	exports.tryToParseBoolean =
	exports.tryToParseAlphanumericString =
	exports.tryToParseString =
	exports.tryToParseNumber =
		void 0;
...
const tryToParseAlphanumericString = (value) => {
	...
	if (!regex.test(parsed)) {
		throw new errors_1.ApplicationError('Value is not a valid alphanumeric string', {
			extra: { value },
		});
	}
	return parsed;
...
const tryToParseJsonToFormFields = (value) => {
	...
	try {
		...
		for (const [index, field] of rawFields.entries()) {
			for (const key of Object.keys(field)) {
				if (!ALLOWED_FORM_FIELDS_KEYS.includes(key)) {
					throw new errors_1.ApplicationError(
		...
		if (error instanceof errors_1.ApplicationError) throw error;
...
const tryToParseJwt = (value) => {
	const error = new errors_1.ApplicationError(
