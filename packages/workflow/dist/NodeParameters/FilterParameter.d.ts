...
export declare function arrayContainsValue(
	array: unknown[],
	value: unknown,
	ignoreCase: boolean,
): boolean;
export declare function executeFilterCondition(
...
export declare function executeFilter(
	value: FilterValue,
	{ itemIndex }?: ExecuteFilterOptions,
): boolean;
export declare const validateFilterParameter: (
