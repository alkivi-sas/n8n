...
function parseSingleFilterValue(value, type, strict = false, version = 1) {
	...
	return (0, TypeValidation_1.validateFieldType)('filter', value, type, {
		strict,
		parseStrings: true,
	});
}
	...
	if (!leftValid && !rightValid && typeof condition.leftValue === typeof condition.rightValue) {
		return {
			...
			error: new FilterError(
				`Comparison type expects ${withIndefiniteArticle(operator.type)} but both fields are ${withIndefiniteArticle(typeof condition.leftValue)}`,
