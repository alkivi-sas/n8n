...
exports.evaluateExpression =
	exports.getEvaluator =
	exports.checkEvaluatorDifferences =
	exports.setDifferEnabled =
	exports.setDiffReporter =
	exports.setEvaluator =
...
const evaluateExpression = (expr, data) => {
	...
	if (wasTmplError !== wasTournError || JSON.stringify(tmplValue) !== JSON.stringify(tournValue)) {
		try {
			if (diff.expression) {
				differenceHandler(diff.expression.value);
			} else {
