...
exports.SupportedHashAlgorithms = ['md5', 'sha1', 'sha224', 'sha256', 'sha384', 'sha512', 'sha3'];
	...
	switch (algorithm) {
		...
		default:
			throw new expression_extension_error_1.ExpressionExtensionError(
				`Unknown algorithm ${algorithm}. Available algorithms are: ${exports.SupportedHashAlgorithms.join()}, and Base64.`,
			);
	}
}
