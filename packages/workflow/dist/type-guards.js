...
exports.isFilterValue =
	...
	exports.isValidResourceLocatorParameterValue =
...
const isINodePropertyOptions = (item) =>
	'value' in item && 'name' in item && !('displayName' in item);
exports.isINodePropertyOptions = isINodePropertyOptions;
const isINodePropertyCollection = (item) =>
	'values' in item && 'name' in item && 'displayName' in item;
exports.isINodePropertyCollection = isINodePropertyCollection;
const isINodePropertiesList = (items) =>
	Array.isArray(items) && items.every(exports.isINodeProperties);
exports.isINodePropertiesList = isINodePropertiesList;
const isINodePropertyOptionsList = (items) =>
	Array.isArray(items) && items.every(exports.isINodePropertyOptions);
