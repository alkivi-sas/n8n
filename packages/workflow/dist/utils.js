...
const isObjectEmpty = (obj) => {
	...
	if (typeof obj === 'object') {
		if (obj instanceof form_data_1.default) return obj.getLengthSync() === 0;
...
function parseJSObject(objectAsString) {
	const jsExpression = (0, esprima_next_1.parse)(`(${objectAsString})`).body.find(
		(node) =>
			node.type === esprima_next_1.Syntax.ExpressionStatement &&
			node.expression.type === esprima_next_1.Syntax.ObjectExpression,
	);
...
const jsonStringify = (obj, options = {}) => {
	return JSON.stringify(
		options?.replaceCircularRefs ? (0, exports.replaceCircularReferences)(obj) : obj,
	);
};
	...
	Object.entries(obj).forEach(([key, value]) => {
		if ((0, exports.isTraversableObject)(value)) {
			seen.has(value)
				...
				: (0, exports.removeCircularRefs)(value, seen);
			return;
		}
