...
export declare function updateDisplayOptions(
	...
	options?: Array<
		| import('./Interfaces').INodePropertyOptions
		| INodeProperties
		| import('./Interfaces').INodePropertyCollection
	>;
	placeholder?: string;
...
export declare function hasKey<T extends PropertyKey>(
	value: unknown,
	key: T,
