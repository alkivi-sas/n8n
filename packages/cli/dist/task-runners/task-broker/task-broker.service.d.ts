...
export declare class TaskBroker {
	...
	constructor(
		...
		taskRunnerLifecycleEvents: TaskRunnerLifecycleEvents,
	);
	expireTasks(): void;
	...
	handleRequesterNodeTypesResponse(
		taskId: Task['id'],
