...
export declare const getAuthIdentityByLdapId: (
	idAttributeValue: string,
) => Promise<AuthIdentity | null>;
export declare const getUserByEmail: (email: string) => Promise<User | null>;
export declare const mapLdapAttributesToUser: (
	ldapUser: LdapUser,
...
export declare const mapLdapUserToDbUser: (
	ldapUser: LdapUser,
	ldapConfig: LdapConfig,
	toCreate?: boolean,
) => [string, User];
export declare const processUsers: (
	toCreateUsers: Array<[string, User]>,
	toUpdateUsers: Array<[string, User]>,
	toDisableUsers: string[],
) => Promise<void>;
export declare const saveLdapSynchronization: (
	data: Omit<AuthProviderSyncHistory, 'id' | 'providerType'>,
) => Promise<void>;
export declare const getLdapSynchronizations: (
	page: number,
	perPage: number,
...
export declare const createLdapUserOnLocalDb: (
	data: Partial<User>,
	ldapId: string,
) => Promise<User>;
export declare const updateLdapUserOnLocalDb: (
