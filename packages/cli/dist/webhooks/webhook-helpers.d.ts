...
export declare function getWorkflowWebhooks(
	workflow: Workflow,
	additionalData: IWorkflowExecuteAdditionalData,
	destinationNode?: string,
	ignoreRestartWebhooks?: boolean,
): IWebhookData[];
export declare function autoDetectResponseMode(
	workflowStartNode: INode,
	workflow: Workflow,
	method: string,
): WebhookResponseMode | undefined;
export declare const handleFormRedirectionCase: (
	data: IWebhookResponseCallbackData,
	workflowStartNode: INode,
) => IWebhookResponseCallbackData;
export declare function getResponseOnReceived(
	responseData: WebhookResponseData | string | undefined,
	webhookResultData: IWebhookResponseData,
	responseCode: number,
): IWebhookResponseCallbackData;
export declare function setupResponseNodePromise(
...
export declare function prepareExecutionData(
...
export declare function executeWebhook(
	workflow: Workflow,
