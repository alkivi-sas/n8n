...
if (executionProcess) {
	logger.error(
		picocolors_1.default.yellow('Please unset the deprecated env variable') +
...
if (executionProcess === 'own') {
	logger.error(
		picocolors_1.default.bold(
			picocolors_1.default.red('Application failed to start because "Own" mode has been removed.'),
		),
	);
	logger.error(
