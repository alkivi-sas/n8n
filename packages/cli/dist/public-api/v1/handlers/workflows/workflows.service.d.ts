...
} from '../../../../databases/entities/shared-workflow';
import type { User } from '../../../../databases/entities/user';
import { WorkflowEntity } from '../../../../databases/entities/workflow-entity';
export declare function getSharedWorkflowIds(
	user: User,
	scopes: Scope[],
	projectId?: string,
): Promise<string[]>;
export declare function getSharedWorkflow(
	user: User,
...
export declare function setWorkflowAsInactive(
...
export declare function getWorkflowTags(
	workflowId: string,
): Promise<import('../../../../databases/entities/tag-entity').TagEntity[]>;
