...
export declare const globalScope: (scopes: Scope | Scope[]) => (
...
export declare const validCursor: (
	req: PaginatedRequest,
	res: express.Response,
	next: express.NextFunction,
) => express.Response | void;
export declare const validLicenseWithUserQuota: (
	_: express.Request,
	res: express.Response,
	next: express.NextFunction,
) => express.Response | void;
export declare const isLicensed: (
