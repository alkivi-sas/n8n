...
export declare class ExecutionService {
	...
	constructor(
		...
		executionAnnotationRepository: ExecutionAnnotationRepository,
		annotationTagMappingRepository: AnnotationTagMappingRepository,
		executionRepository: ExecutionRepository,
		workflowRepository: WorkflowRepository,
		nodeTypes: NodeTypes,
		waitTracker: WaitTracker,
		workflowRunner: WorkflowRunner,
		concurrencyControl: ConcurrencyControlService,
		license: License,
	...
	retry(
		...
		'error' | 'success' | 'unknown' | 'canceled' | 'crashed' | 'new' | 'running' | 'waiting'
	>;
