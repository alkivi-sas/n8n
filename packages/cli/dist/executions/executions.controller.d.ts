...
export declare class ExecutionsController {
	...
	constructor(
		...
		enterpriseExecutionService: EnterpriseExecutionsService,
	...
	getOne(
		...
		| import('../interfaces').IExecutionResponse
		| import('../interfaces').IExecutionFlattedResponse
		| undefined
	>;
