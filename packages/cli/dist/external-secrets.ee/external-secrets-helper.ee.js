...
const updateIntervalTime = () =>
	di_1.Container.get(config_1.GlobalConfig).externalSecrets.updateInterval * 1000;
exports.updateIntervalTime = updateIntervalTime;
const preferGet = () => di_1.Container.get(config_1.GlobalConfig).externalSecrets.preferGet;
