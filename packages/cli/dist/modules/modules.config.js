	...
	constructor(str) {
		...
		for (const moduleName of this) {
			if (!moduleNames.includes(moduleName)) {
				throw new n8n_workflow_1.UnexpectedError(`Unknown module name ${moduleName}`, {
					level: 'fatal',
				});
			}
		}
...
__decorate(
	[(0, config_1.Env)('N8N_ENABLED_MODULES'), __metadata('design:type', Modules)],
	ModulesConfig.prototype,
	'modules',
	void 0,
);
exports.ModulesConfig = ModulesConfig = __decorate([config_1.Config], ModulesConfig);
