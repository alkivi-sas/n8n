...
export declare class VariablesController {
	...
	getVariables(
		_req: unknown,
		_res: unknown,
		query: VariableListRequestDto,
	): Promise<import('../../databases/entities/variables').Variables[]>;
	createVariable(
		req: VariablesRequest.Create,
	): Promise<import('../../databases/entities/variables').Variables>;
	getVariable(
		req: VariablesRequest.Get,
	): Promise<import('../../databases/entities/variables').Variables>;
	updateVariable(
		req: VariablesRequest.Update,
	): Promise<import('../../databases/entities/variables').Variables>;
