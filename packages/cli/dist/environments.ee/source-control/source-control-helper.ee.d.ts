...
export declare function getWorkflowExportPath(
	workflowId: string,
	workflowExportFolder: string,
): string;
export declare function getCredentialExportPath(
	credentialId: string,
...
export declare function sourceControlFoldersExistCheck(
	folders: string[],
...
export declare function normalizeAndValidateSourceControlledFilePath(
