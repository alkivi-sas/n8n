...
export declare class FolderService {
	...
	constructor(
		...
		folderTagMappingRepository: FolderTagMappingRepository,
		workflowRepository: WorkflowRepository,
	);
	createFolder(
		{ parentFolderId, name }: CreateFolderDto,
		projectId: string,
	): Promise<{
		name: string;
	...
	getManyAndCount(
		...
		[import('../databases/entities/folder').FolderWithWorkflowAndSubFolderCount[], number]
	>;
}
