...
export declare function createPinData(
	workflow: IWorkflowBase,
	mockedNodes: MockedNodeItem[],
	executionData: IRunExecutionData,
	pastWorkflowData?: IWorkflowBase,
): IPinData;
export declare function getPastExecutionTriggerNode(
	executionData: IRunExecutionData,
): string | undefined;
export declare function getTestRunFinalResult(
	testCaseExecutions: TestCaseExecution[],
): TestRunFinalResult;
export declare function formatTestCaseExecutionInputData(
