...
export declare class TestDefinitionsController {
	...
	>;
	getOne(
		req: TestDefinitionsRequest.GetOne,
	): Promise<import('../databases/entities/test-definition.ee').TestDefinition>;
	create(
		req: TestDefinitionsRequest.Create,
		res: express.Response,
	): Promise<import('../databases/entities/test-definition.ee').TestDefinition | undefined>;
	delete(req: TestDefinitionsRequest.Delete): Promise<{
		success: boolean;
	}>;
	patch(
		req: TestDefinitionsRequest.Patch,
		res: express.Response,
	): Promise<import('../databases/entities/test-definition.ee').TestDefinition | undefined>;
	...
	exampleEvaluationInput(req: TestDefinitionsRequest.ExampleEvaluationInput): Promise<{
		annotations: {
			...
			tags:
				| Pick<
						import('../databases/entities/annotation-tag-entity.ee').AnnotationTagEntity,
						'id' | 'name'
				  >[]
				| undefined;
			highlightedData: {
