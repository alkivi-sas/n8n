...
export declare class ExecuteBatch extends BaseCommand {
	...
	static flags: {
		...
		ids: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
		...
		concurrency: import('@oclif/core/lib/interfaces').OptionFlag<
			...
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		output: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		snapshot: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		compare: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		...
		skipList: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		retries: import('@oclif/core/lib/interfaces').OptionFlag<
			number,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
