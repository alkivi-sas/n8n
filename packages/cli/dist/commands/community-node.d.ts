...
export declare class CommunityNode extends BaseCommand {
	...
	static flags: {
		...
		package: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		credential: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
		userId: import('@oclif/core/lib/interfaces').OptionFlag<
			string | undefined,
			import('@oclif/core/lib/interfaces').CustomOptions
		>;
	};
	...
	parseFlags(): Promise<
		import('@oclif/core/lib/interfaces').ParserOutput<
			{
				help: void;
				uninstall: boolean;
