...
const initExpressionEvaluator = () => {
	n8n_workflow_1.ExpressionEvaluatorProxy.setEvaluator(
		config_1.default.getEnv('expression.evaluator'),
	);
	n8n_workflow_1.ExpressionEvaluatorProxy.setDifferEnabled(
		config_1.default.getEnv('expression.reportDifference'),
	);
