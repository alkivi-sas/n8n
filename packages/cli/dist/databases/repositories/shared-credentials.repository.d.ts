...
export declare class SharedCredentialsRepository extends Repository<SharedCredentials> {
	...
	): Promise<import('../entities/credentials-entity').CredentialsEntity | null>;
	findAllCredentialsForUser(
		user: User,
		scopes: Scope[],
		trx?: EntityManager,
	): Promise<
	...
	makeOwner(
		...
		projectId: string,
		trx?: EntityManager,
	): Promise<import('@n8n/typeorm').InsertResult>;
	...
	deleteByIds(
		sharedCredentialsIds: string[],
		projectId: string,
		trx?: EntityManager,
	): Promise<import('@n8n/typeorm').DeleteResult>;
	getFilteredAccessibleCredentials(
		projectIds: string[],
