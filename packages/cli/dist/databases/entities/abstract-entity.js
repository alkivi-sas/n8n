...
exports.WithTimestampsAndStringId =
	exports.WithTimestamps =
	exports.WithStringId =
	exports.datetimeColumnType =
	exports.jsonColumnType =
	exports.dbType =
		void 0;
...
function mixinTimestamps(base) {
	...
	__decorate(
		[(0, typeorm_1.CreateDateColumn)(tsColumnOptions), __metadata('design:type', Date)],
		Derived.prototype,
		'createdAt',
		void 0,
	);
	__decorate(
		[(0, typeorm_1.UpdateDateColumn)(tsColumnOptions), __metadata('design:type', Date)],
		Derived.prototype,
		'updatedAt',
		void 0,
	);
