...
__decorate(
	[(0, typeorm_1.PrimaryColumn)({ type: 'text' }), __metadata('design:type', String)],
	WebhookEntity.prototype,
	'method',
	void 0,
);
...
exports.WebhookEntity = WebhookEntity = __decorate(
	[(0, typeorm_1.Entity)(), (0, typeorm_1.Index)(['webhookId', 'method', 'pathLength'])],
	WebhookEntity,
);
