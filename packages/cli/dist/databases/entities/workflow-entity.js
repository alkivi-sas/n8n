...
__decorate(
	[(0, typeorm_1.Column)(abstract_entity_1.jsonColumnType), __metadata('design:type', Array)],
	WorkflowEntity.prototype,
	'nodes',
	void 0,
);
__decorate(
	[(0, typeorm_1.Column)(abstract_entity_1.jsonColumnType), __metadata('design:type', Object)],
	WorkflowEntity.prototype,
	'connections',
	void 0,
);
...
__decorate(
	[(0, typeorm_1.OneToMany)('WorkflowTagMapping', 'workflows'), __metadata('design:type', Array)],
	WorkflowEntity.prototype,
	'tagMappings',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('SharedWorkflow', 'workflow'), __metadata('design:type', Array)],
	WorkflowEntity.prototype,
	'shared',
	void 0,
);
...
__decorate(
	[(0, typeorm_1.Column)({ length: 36 }), __metadata('design:type', String)],
	WorkflowEntity.prototype,
	'versionId',
	void 0,
);
...
exports.WorkflowEntity = WorkflowEntity = __decorate([(0, typeorm_1.Entity)()], WorkflowEntity);
