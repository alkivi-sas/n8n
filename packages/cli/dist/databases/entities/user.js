...
let User = class User extends abstract_entity_1.WithTimestamps {
	...
	hasGlobalScope(scope, scopeOptions) {
		return (0, permissions_1.hasScope)(
			scope,
			{
...
__decorate(
	[
		...
		(0, class_validator_1.Length)(1, 32, {
			message: 'First name must be $constraint1 to $constraint2 characters long.',
		}),
		__metadata('design:type', String),
	],
	User.prototype,
...
__decorate(
	[
		...
		(0, class_validator_1.Length)(1, 32, {
			message: 'Last name must be $constraint1 to $constraint2 characters long.',
		}),
		__metadata('design:type', String),
	],
	User.prototype,
...
__decorate(
	[(0, typeorm_1.OneToMany)('AuthIdentity', 'user'), __metadata('design:type', Array)],
	User.prototype,
	'authIdentities',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('ApiKey', 'user'), __metadata('design:type', Array)],
	User.prototype,
	'apiKeys',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('SharedWorkflow', 'user'), __metadata('design:type', Array)],
	User.prototype,
	'sharedWorkflows',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('SharedCredentials', 'user'), __metadata('design:type', Array)],
	User.prototype,
	'sharedCredentials',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('ProjectRelation', 'user'), __metadata('design:type', Array)],
	User.prototype,
	'projectRelations',
	void 0,
);
__decorate(
	[(0, typeorm_1.Column)({ type: Boolean, default: false }), __metadata('design:type', Boolean)],
	User.prototype,
	'disabled',
	void 0,
);
