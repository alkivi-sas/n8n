...
__decorate(
	[(0, typeorm_1.RelationId)((test) => test.workflow), __metadata('design:type', String)],
	TestDefinition.prototype,
	'workflowId',
	void 0,
);
...
__decorate(
	[(0, typeorm_1.RelationId)((test) => test.evaluationWorkflow), __metadata('design:type', String)],
	TestDefinition.prototype,
...
__decorate(
	[(0, typeorm_1.RelationId)((test) => test.annotationTag), __metadata('design:type', String)],
	TestDefinition.prototype,
	'annotationTagId',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('TestMetric', 'testDefinition'), __metadata('design:type', Array)],
	TestDefinition.prototype,
	'metrics',
	void 0,
);
