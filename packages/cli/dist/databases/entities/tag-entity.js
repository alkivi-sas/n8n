...
__decorate(
	[(0, typeorm_1.ManyToMany)('WorkflowEntity', 'tags'), __metadata('design:type', Array)],
	TagEntity.prototype,
	'workflows',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('WorkflowTagMapping', 'tags'), __metadata('design:type', Array)],
	TagEntity.prototype,
	'workflowMappings',
	void 0,
);
__decorate(
	[(0, typeorm_1.OneToMany)('FolderTagMapping', 'tags'), __metadata('design:type', Array)],
	TagEntity.prototype,
	'folderMappings',
	void 0,
);
exports.TagEntity = TagEntity = __decorate([(0, typeorm_1.Entity)()], TagEntity);
