...
export declare const isMessageEventBusDestinationWebhookOptions: (
	candidate: unknown,
) => candidate is MessageEventBusDestinationWebhookOptions;
export declare class MessageEventBusDestinationWebhook
	...
	implements MessageEventBusDestinationWebhookOptions
{
	...
	matchDecryptedCredentialType(
		credentialType: string,
	): Promise<import('n8n-workflow').ICredentialDataDecryptedObject | null | undefined>;
