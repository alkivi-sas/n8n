...
export declare const eventNamesAiNodes: readonly [
...
export declare const eventNamesWorkflow: readonly [
...
export declare const eventNamesExecution: readonly [
	'n8n.execution.throttled',
	'n8n.execution.started-during-bootup',
];
export declare const eventNamesAudit: readonly [
...
export declare const eventNamesAll: (
	| 'n8n.audit.user.login.success'
	| 'n8n.audit.user.login.failed'
	| 'n8n.audit.user.signedup'
	| 'n8n.audit.user.updated'
