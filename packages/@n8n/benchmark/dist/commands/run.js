...
class RunCommand extends core_1.Command {
	async run() {
		...
		const scenarioRunner = new scenario_runner_1.ScenarioRunner(
			new n8n_api_client_1.N8nApiClient(flags.n8nBaseUrl),
			new scenario_data_loader_1.ScenarioDataFileLoader(),
			new k6_executor_1.K6Executor({
