      ...
      try {
        if (resource === "ticket") {
          if (operation === "create") {
            ...
            const body = {
              // @ts-ignore
              status: Statuses[(0, import_GenericFunctions.capitalize)(status)],
              // @ts-ignore
              priority: Priorities[(0, import_GenericFunctions.capitalize)(priority)],
              // @ts-ignore
              source: Sources[(0, import_GenericFunctions.capitalize)(source)]
            };
